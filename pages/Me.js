...
const Me=()=>{
    return(
        <div className={styles.container}>
            ...
            <p>Nice to meet you again I aM a fullstack developer mainly based on MERN stack, I create and desighn websites, I am self-motivated, time conciuos and ready to be corrected.I am cormfortable working in both team and alone because I have experience for both.I have good communication and presentation skills this has actually enabled me to work in team and also be their leader.I am able to create a whole website in a month , I take One and half week to create frontend that is the UI and two weeks to create backend that is the UX, Since I have good presentation skill I design the presentation using Canvas and then present to clien.I have not gotten any negative feedback from the group and also clients  have worked with, This clearly shows that I am coperative and follow instructions as given.  </p>
...
<p >Crafted with<span style={{color:"red"}}> &hearts;</span> Ademba Sharon</p>
</div>
</div>
